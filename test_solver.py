...
class TestSolver(unittest.TestCase):
	...
	def test_ramp1(self):
		...
		self.assertTrue(np.allclose([50.0,50.0,50.0],mySat.getW_BO_b()))
	...
	def test_ramp2(self):
		...
		self.assertTrue(np.allclose([51.6,47.5,50.3],mySat.getW_BO_b()))
	...
	def test_tx(self):
		...
		expected = np.exp(-t**2/2.)*np.array([1.6,-2.5,0.3])
		
		self.assertTrue(np.allclose(expected,mySat.getW_BO_b()))
	...
	def test_dynamics(self):
		...
		self.assertTrue(np.allclose(error_state,mySat.getState()))
